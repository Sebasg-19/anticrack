...
[al]="Albania" [be]="Belgium" [bg]="Bulgaria" [ca]="Canada" [hr]="Croatia" [cz]="Czech Republic" [dk]="Denmark" [ee]="Estonia" [fi]="Finland" [fr]="France" [de]="Germany" [gr]="Greece" [hu]="Hungary" [is]="Iceland" [it]="Italy" [lv]="Latvia" [lt]="Lithuania" [lu]="Luxembourg" [me]="Montenegro" [nl]="Netherlands" [mk]="North Macedonia" [no]="Norway" [pl]="Poland" [pt]="Portugal" [ro]="Romania" [sk]="Slovakia" [si]="Slovenia" [es]="Spain" [se]="Sweden" [tr]="Turkey" [gb]="United Kingdom" [us]="United States" [in]="India" [br]="Brazil" [za]="South Africa" [ua]="Ukraine" [nsa]="NSA" [fbi]="FBI" )
countries=(cn ru ir kp by sy ve cu pk kh mm ni er ml cf bf ne gl al be bg ca hr cz dk ee fi fr de gr hu is it lv lt lu me nl mk no pl pt ro sk si es se tr gb us in br za ua nsa fbi)
# Predefined groups for blocking
declare -A groups
groups[enemies]="ru cn ir ve kp gl"
groups[allies]="by sy cu pk kh mm ni er ml cf bf ne"
groups[all_enemies]="ru cn ir ve kp gl by sy cu pk kh mm ni er ml cf bf ne nsa fbi"
